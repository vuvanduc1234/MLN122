          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <section className="space-y-6">
              {situationsData.map((sit) => {
                const isExpanded = expandedSituation === sit.id;
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-4 flex-grow">
                        ...
                        <div>
                          ...
                          <h3 className="text-lg font-bold text-slate-800 mt-1.5 leading-normal font-outfit">
                            {sit.id}. {sit.title}
                          </h3>
                        </div>
                      </div>
                    ...
                    {/* Expandable Body */}
                    {isExpanded && (
                      <div className="px-6 pb-6 pt-2 border-t border-slate-200/80 space-y-6 animate-scale-in">
                        ...
                        <div className="border border-yellow-500/20 bg-yellow-950/10 rounded-2xl p-5 space-y-4">
